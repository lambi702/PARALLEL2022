...
bool
Tinyraytracer::scene_intersect(const Vec3f &orig, const Vec3f &dir, Vec3f &hit, Vec3f &N, float anglel, Material &material)
{
...
Tinyraytracer::render(float anglev, float angleh, float anglel, float z_red, float size_mirror)
{
  ...
  this->update_size_mirro(size_mirror);
...
Tinyraytracer::update_z_red(float z_red)
{
  this->spheres[1].center[2] = z_red;
}

Tinyraytracer::update_z_red(float size_mirror)
{
  this->spheres[1].r = size_mirror;
}
